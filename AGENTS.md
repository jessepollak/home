...
- **Design handoff coverage.** A design or library handoff maps every follow-up to one durable disposition in a single coverage table; its reviewer checks coverage and design/code parity. Follow [design handoff coverage](docs/operating-manual.md#design-handoff-coverage).
