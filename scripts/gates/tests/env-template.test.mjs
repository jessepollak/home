...
const TEST_ONLY_ALLOWLIST = [
  ...
  "FAKE_AGENT_BROWSER_AUTH_HTML",
  "FAKE_AGENT_BROWSER_DISABLED",
  "FAKE_AGENT_BROWSER_FAIL_CALL",
  "FAKE_AGENT_BROWSER_LOG",
  "FAKE_AGENT_BROWSER_MARKED",
  "FAKE_AGENT_BROWSER_REFS",
  "FAKE_AGENT_BROWSER_REQUESTS",
  "FAKE_AGENT_BROWSER_SNAPSHOT",
  "FAKE_AGENT_BROWSER_URL",
  "FUNDING_PG_TEST_URL",
