...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-lg border text-sm transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      ...
      size: {
        default: "min-h-14 gap-2.5 px-3 py-3",
  ...
  "flex shrink-0 items-center justify-center gap-2 [&_svg]:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        avatar:
          "size-8 self-center translate-y-0 overflow-hidden rounded-full bg-muted text-muted-foreground group-data-[size=sm]/item:size-7 [&_img]:size-full [&_img]:object-cover [&_svg:not([class*='size-'])]:size-4",
      },
    },
    defaultVariants: {
      variant: "default",
