...
For the app contract, read [Architecture](../../docs/architecture.md) and [Actions](../../docs/actions.md); for current boundaries, read the [architecture review](../../docs/architecture-review-2026-09.md). This workspace contains routes and presentation in `app/`, client experiences in `client/`, shared contracts in `shared/`, authenticated boundaries in `server/`, and typed product configuration in `config/`.
