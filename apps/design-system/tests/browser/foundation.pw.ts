...
async function expectNoOverflow(page: Page) {
  ...
  const clipped = await page.locator(".home-ui-text, .home-ui-money-ticker, .home-ui-button, .home-ui-field, .home-ui-control, .home-ui-empty-state, .home-ui-status-message, .home-ui-toast, .catalog-section, .catalog-controls, .catalog-control-grid, .catalog-control-grid label").evaluateAll((elements) =>
