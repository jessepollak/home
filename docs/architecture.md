...
The `home/no-computed-style-in-component-tests` Oxlint rule rejects `getComputedStyle` assertions in component tests and stories; geometry belongs in Playwright.
