...
| CAD · Canada | CADD · Tetra Trust | Additional verification | Selected default and priority route. Tetra documents institution-led CAD mint/redemption and a native Base contract; verify commercial/API access and eligible audience before enabling. CADC is not the selected priority route. [CADD](https://tetradg.com/cadd-stablecoin/) |
