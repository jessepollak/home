...
Pure provider submission classifications live in `apps/web/shared/money-actions/provider-submission-contract.ts` and are consumed by client execution. Locked provider facts: [attempt-aware onchain transactions](onchain-transaction-architecture.md#provider-specific-facts-and-unknowns).
