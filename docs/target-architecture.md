...
**Current tree (read these first):** [build status](build-status.md) · [wallet runtime spike](wallet-runtime-spike.md) · [architecture review](architecture-review-2026-09.md) · [docs index](README.md)
