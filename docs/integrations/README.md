...
No guide step grants issuer-account, deployment, provider-enablement, or merge authority. Live probes remain outside CI. The verifier may use the bot account's provisioned credentials and funded authority only within policy and ledger bounds; Jesse alone changes caps, approves, and merges. See the [verification ladder](../operating-manual.md#verification-ladder) and [repository gates](../gates.md).
