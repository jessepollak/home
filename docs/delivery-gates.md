...
- `bun run factory:preflight` as the generic automated-worktree boundary (pinned repository, `agent/*` branch, and secret-free worktree/ambient environment); it does not implement or invoke the standalone queue
- `bun check`
