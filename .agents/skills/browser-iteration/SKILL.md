...
The verifier's Live mode may automate the bot OTP and funded confirmation, pins `j@pollak.io` from the rendered Account surface, and enforces policy, ledger arm state, balance, recipient, amount, and incident guards.
