...
- **Live**: read-only
- **Owned paths**: `apps/web/client/account/account-settings.tsx`, `apps/web/client/home/shell-panels.tsx`, `apps/web/client/home/use-show-small-balances.ts`, `apps/web/client/appearance/**`, `apps/web/shared/appearance/**`
- **Reach**:
...
- **States**: preference not ready (`isPreferenceReady`); region override messages (`preferenceMessage`); appearance Light / Dark / System (including system changes) and storage-unavailable announcement in the polite preference status; narrow 320px row wraps the radiogroup under its title.
